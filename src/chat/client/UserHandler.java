...
class UserHandler implements Runnable
{
	...
	public void run()
	{
		...
		while (commonRun.booleanValue())
		{
			...
			{
				logger.severe("UserHandle: IOexception while reading input.");
				break;
			}
			if (userInput != null)
			{
				...
				{
					logger.warning("UserHandle: serverOutPw has errors");
					break;
				}
				
				if(userInput.contentEquals(new StringBuffer("bye")))
					break;
